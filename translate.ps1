...
$directories = @("upproteinafrances", "upperdadepesofrances", "upgorduranofigadofrances", "updiabetesfrances", "downdiabeteesfrances", "downgorduranofigadofrances", "downperdadepesofrances", "downproteinafrances")
